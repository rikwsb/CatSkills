                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal-code" type="text" class="form-control @error('postal-code') is-invalid @enderror" name="postal-code" value="{{ old('postal-code') }}" required autocomplete="name" autofocus>
